export default {
  "enableRest": process.env.ENABLE_REST === 'true' ? true : false, 
  "restPort": parseInt(process.env.REST_PORT) || 5099, 
  "enableMetricsExporter": process.env.ENABLE_METRICS === 'true' ? true : false, 
  "metricsPort": parseInt(process.env.METRICS_PORT) || 13337, 
  "enableWebsockets": process.env.ENABLE_WEBSOCKETS === 'true' ? true : false, 
