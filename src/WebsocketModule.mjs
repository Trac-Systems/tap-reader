      ...
      socket.on("get", async (cmd) => {
        ...
        try {
          const directPerpRoutes = {
            ...
            perpExternalEvidence: ["getPerpExternalEvidence", 1],
            perpExternalEvidenceListLength: ["getPerpExternalEvidenceListLength", 0],
            perpExternalEvidenceList: ["getPerpExternalEvidenceList", 2],
            perpExternalEvidenceByGroupLength: ["getPerpExternalEvidenceByGroupLength", 1],
            perpExternalEvidenceByGroup: ["getPerpExternalEvidenceByGroup", 3],
            perpExternalEvidenceByPositionLength: ["getPerpExternalEvidenceByPositionLength", 1],
            perpExternalEvidenceByPosition: ["getPerpExternalEvidenceByPosition", 3],
            perpExternalEvidenceByChainLength: ["getPerpExternalEvidenceByChainLength", 1],
            perpExternalEvidenceByChain: ["getPerpExternalEvidenceByChain", 3],
            perpEvidenceEventsByBlockLength: ["getPerpEvidenceEventsByBlockLength", 1],
            perpEvidenceEventsByBlock: ["getPerpEvidenceEventsByBlock", 3],
            perpEvidenceEventsByTransactionLength: ["getPerpEvidenceEventsByTransactionLength", 1],
            perpEvidenceEventsByTransaction: ["getPerpEvidenceEventsByTransaction", 3],
